...
def run_agent(question:str, tools:list, tool_impls:dict, messages) -> dict:
   client = Anthropic()
...
def compact_run(questions: list, tools, tools_impls):
   messages = []
   total_tokens = 0
   ...
   for i, q in enumerate(questions):
      ...
      response = run_agent(q, tools, tools_impls, messages)
...
if __name__ == "__main__":
   ...
   compact_run(QUESTIONS, TOOLS_B, TOOLS_B_IMPLS)
