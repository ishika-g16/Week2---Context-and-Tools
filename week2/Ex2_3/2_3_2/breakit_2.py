'''
Exercise 2.3 Break it Lab - Part 2:
This file contains the run_agent for note poisoning 
Runs with 1 question taken from command line as input 
Uses toolset_b with write_note and read_note tools 
